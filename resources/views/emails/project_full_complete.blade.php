...
<head>
    ...
    <title>WITrack Project Full Order Completed</title>
    <style>
        body {
...
<body>
    <div class="container">
        <div class="header">
            ✅ Project's Full Order is Completed - {{ $emailData['project_no'] }} - {{ $emailData['project_name'] }}
        </div>
        <div class="content">
            <h3>Hi {{ $emailData['name'] }},</h3>
            <p>This project's full order with the following details has been completed:</p>
