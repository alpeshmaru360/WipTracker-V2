                ...
                <div class="col-12 col-md-9 col-lg-7 col-xl-12">
                    <div class="card" style="border-radius: 15px;">
                        <div class="card-body p-4">
                            ...
                            @endif
                            <form action="{{ route('updateNCR', $ncrData->id) }}" enctype="multipart/form-data"
                                method="post">
                                @csrf
                                ...
                                <div class="row mt-3">
                                    <div class="col-6">
                                        ...
                                        <input type="text" id="cia_no" class="form-control" name="cia_no" required
                                            value="{{ $ncrData->cia_no }}" readonly />
                                    </div>
                                    <div class="col-6">
                                        <label class="form-label" for="ncr_type">Types of NCR<span
                                                class="text-danger">*</span></label>
                                        <select id="ncr_type" class="form-control" name="ncr_type" required>
                                            <option value="" disabled>Select Type of NCR</option>
                                            <option value="Improvement Internal" {{ $ncrData->ncr_type == 'Improvement Internal' ? 'selected' : '' }}>Improvement Internal</option>
                                            <option value="Internal Audit" {{ $ncrData->ncr_type == 'Internal Audit' ? 'selected' : '' }}>Internal Audit</option>
                                            <option value="Customer Complains" {{ $ncrData->ncr_type == 'Customer Complains' ? 'selected' : '' }}>Customer Complains</option>
                                            <option value="Non-Conformity-Internal" {{ $ncrData->ncr_type == 'Non-Conformity-Internal' ? 'selected' : '' }}>
                                                Non-Conformity-Internal</option>
                                            <option value="Supplier Non-Conformity" {{ $ncrData->ncr_type == 'Supplier Non-Conformity' ? 'selected' : '' }}>Supplier Non-Conformity</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="row mt-3">
                                    <div class="col-6">
                                        ...
                                        <select id="related_dep" class="form-control" name="related_dep" required>
                                            <option value="" disabled>Select Related Department</option>
                                            <option value="Quality" {{ $ncrData->related_dep == 'Quality' ? 'selected' : '' }}>Quality</option>
                                            <option value="Engineering" {{ $ncrData->related_dep == 'Engineering' ? 'selected' : '' }}>Engineering</option>
                                            <option value="Production" {{ $ncrData->related_dep == 'Production' ? 'selected' : '' }}>Production</option>
                                            <option value="Customer" {{ $ncrData->related_dep == 'Customer' ? 'selected' : '' }}>Customer</option>
                                        </select>
                                    </div>
                                    <div class="col-6">
                                        <label class="form-label" for="project_no">Project No<span
                                                class="text-danger">*</span></label>
                                        <input type="text" id="project_no" class="form-control" name="project_no"
                                            required value="{{ $ncrData->project_no }}" readonly />
                                    </div>
                                </div>
                                <div class="row mt-3">
                                    <div class="col-6">
                                        ...
                                        <input type="text" id="project" class="form-control" name="project" required
                                            value="{{ $ncrData->project }}" readonly />
                                    </div>
                                    <div class="col-6">
                                        ...
                                        <input type="text" id="po" class="form-control" name="po" required
                                            value="{{ $ncrData->po }}" placeholder="PO-YYYY-XXXXX"
                                            pattern="PO-\d{4}-\d+"
                                ...
                                <div class="row mt-3">
                                    <div class="col-6">
                                        ...
                                        <input type="number" id="article_number" class="form-control"
                                            name="article_number" required value="{{ $ncrData->article_number }}"
                                    ...
                                    <div class="col-6">
                                        ...
                                        <textarea id="ncr_description" class="w-100 pb-2 pt-2" name="ncr_description"
                                            required
                                            placeholder="Enter NCR Description">{{ $ncrData->ncr_description }}</textarea>
                                    </div>
                                </div>
                                <div class="row mt-3">
                                    <div class="col-6">
                                        ...
                                        <textarea id="material_description" class="w-100 pb-2 pt-2"
                                            ...
                                            placeholder="Enter Material Description">{{ $ncrData->material_description }}</textarea>
                                    </div>
                                    <div class="col-6">
                                        <label class="form-label" for="quantity">Quantity<span
                                                class="text-danger">*</span></label>
                                        <input type="number" id="quantity" class="form-control" name="quantity" required
                                            value="{{ $ncrData->quantity }}" placeholder="Enter Quantity" />
                                    </div>
                                </div>
                                <div class="row mt-3">
                                    <div class="col-6">
                                        ...
                                        <input type="text" id="name_surname" class="form-control" name="name_surname"
                                            required value="{{ $ncrData->name_surname }}"
                                    ...
                                    <div class="col-6">
                                        ...
                                        <input type="file" id="signature" class="w-100 pb-2 pt-2" name="signature"
                                            accept="image/*" onchange="previewSignature()" />
                                        <div class="mt-3">
                                            <img id="signature-preview" src="{{ url($ncrData->signature) }}"
                                                alt="Image Preview"
                                ...
                                <div class="row mt-3">
                                    <div class="col-6">
                                        <label class="form-label" for="detected_department">The Department detected the
                                            nonconformity<span class="text-danger">*</span></label>
                                        <select id="detected_department" class="form-control" name="detected_department"
                                            required>
                                            <option value="" disabled>Select Department</option>
                                            <option value="Quality" {{ $ncrData->detected_department == 'Quality' ? 'selected' : '' }}>Quality</option>
                                            <option value="Engineering" {{ $ncrData->detected_department == 'Engineering' ? 'selected' : '' }}>Engineering</option>
                                            <option value="Production" {{ $ncrData->detected_department == 'Production' ? 'selected' : '' }}>Production</option>
                                            <option value="Customer" {{ $ncrData->detected_department == 'Customer' ? 'selected' : '' }}>Customer</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="row mt-3">
                                        ...
                                        <div class="d-flex justify-content-start flex-wrap">
                                            <div class="form-check me-4">
                                                <input class="form-check-input" type="checkbox"
                                                    name="activity_schedule_type[]" id="corrective_action" value="1" {{ $ncrData->is_corrective_action ? 'checked' : '' }}>
                                                <label class="form-check-label" for="corrective_action">Corrective
                                                    Action</label>
                                            </div>
                                            <div class="form-check me-4">
                                                <input class="form-check-input" type="checkbox"
                                                    name="activity_schedule_type[]" id="correction" value="2" {{ $ncrData->is_correction ? 'checked' : '' }}>
                                                <label class="form-check-label" for="correction">Correction</label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" type="checkbox"
                                                    name="activity_schedule_type[]" id="is_improvement_action" value="3"
                                                    {{ $ncrData->is_improvement_action ? 'checked' : '' }}>
                                    ...
                                    <div class="col-6">
                                        ...
                                        <input type="date" id="planned_action_date" class="form-control"
                                            ...
                                            value="{{ $ncrData->planned_action_date }}" />
                                    </div>
                                </div>
                                <div class="row mt-3">
                                    <div class="col-6">
                                        ...
                                        <textarea id="action_to_prevent_misuse" class="form-control"
                                            ...
                                            placeholder="Enter Action Taken to Prevent Misuse">{{ $ncrData->action_to_prevent_misuse }}</textarea>
                                    </div>
                                    <div class="col-6">
                                        <label class="form-label" for="root_cause">ROOT CAUSE</label>
                                        <textarea id="root_cause" class="form-control" name="root_cause"
                                            placeholder="Enter Root Cause">{{ $ncrData->root_cause }}</textarea>
                                    </div>
                                </div>
                                <div class="row mt-3">
                                    <div class="col-6">
                                        ...
                                        <input type="text" id="related_authorized_personnel" class="form-control"
                                            ...
                                            value="{{ $ncrData->related_authorized_personnel }}"
                                    ...
                                    <div class="col-6">
                                        ...
                                        <div class="mt-3">
                                        <img id="related-authorized-personnel-signature-preview"
                                        src="/{{ $ncrData->related_authorized_personnel_signature }}"
                                                alt="Image Preview"
                                                style="max-width: 100%; height: auto; border: 1px solid #ddd; padding: 5px; border-radius: 5px;" />
                                        </div>
                                    </div>
                                ...
                                <div class="row mt-3">
                                    <div class="col-6">
                                        ...
                                        <input type="text" id="quality_management_representative" class="form-control"
                                            ...
                                            value="{{ $ncrData->quality_management_representative }}"
                                    ...
                                    <div class="col-6">
                                        ...
                                        <textarea id="corrective_preventive_action" class="form-control"
                                            ...
                                            placeholder="Enter Corrective/Preventive Action">{{ $ncrData->corrective_preventive_action }}</textarea>
                                    </div>
                                </div>
                                <div class="row mt-3">
                                    <div class="col-12">
                                        ...
                                        <div class="d-flex justify-content-start flex-wrap">
                                            <div class="form-check me-4">
                                                <input type="radio" id="nonconformity_corrected" name="action_follow_up"
                                                    value="Nonconformity is corrected" class="form-check-input" {{ $ncrData->action_follow_up == 'Nonconformity is corrected' ? 'checked' : '' }}>
                                            ...
                                            <div class="form-check me-4">
                                                <input type="radio" id="nonconformity_not_corrected"
                                                    ...
                                                    class="form-check-input" {{ $ncrData->action_follow_up == 'Nonconformity is not corrected' ? 'checked' : '' }}>
                                                <label class="form-check-label"
                                            ...
                                            <div class="form-check me-4">
                                                <input type="radio" id="additional_time" name="action_follow_up"
                                                    value="Additional Time" class="form-check-input" {{ $ncrData->action_follow_up == 'Additional Time' ? 'checked' : '' }}>
                                ...
                                <div class="row mt-3">
                                    <div class="col-6">
                                        ...
                                        <input type="text" id="follow_up" class="form-control" name="follow_up"
                                            value="{{ $ncrData->follow_up }}" placeholder="Enter Follow up" />
                                    </div>
                                    <div class="col-6">
                                        ...
                                        <input type="date" id="action_closed_date" class="form-control"
                                            name="action_closed_date" value="{{ $ncrData->action_closed_date }}" />
                                    </div>
                                </div>
                                <div class="row mt-3">
                                    <div class="col-6">
                                        ...
                                        <input type="text" id="related_authorized_personnel_final" class="form-control"
                                            ...
                                            value="{{ $ncrData->related_authorized_personnel_final }}"
                                            placeholder="Enter Related Authorized Personnel" />
                                    </div>
                                    <div class="col-6">
                                        ...
                                        <input type="text" id="quality_management_representative_date"
                                            ...
                                            value="{{ $ncrData->quality_management_representative_date }}"
                                ...
                                <div class="row mt-3">
                                    <div class="col-12">
                                        ...
                                        <div id="ncr-photos-preview" class="mt-3 d-flex flex-wrap">
                                            @if($ncrData->ncr_photos)
                                            @foreach(json_decode($ncrData->ncr_photos) as $photo)
                                            <div class="preview-image-container">
                                                <img src="{{ asset($photo) }}" class="preview-image" alt="NCR Photo" />
                                ...
                                <div class="d-flex justify-content-center mt-4">
                                    <button type="submit" class="btn btn-lg">Update NCR</button>
                                </div>
                            </form>
                        </div>
                    </div>
