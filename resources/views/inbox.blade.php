...
<div class="main_section bg-white m-4">
    ...
    <div class="d-flex justify-content-between align-items-center">
        <h3 class="ml-4 pt-4 text-bold text-left text-uppercase">Pending BOM Upload</h3>
    ...
    <div class="container">
        <div class="row mt-2">
            ...
            <table class="table table-hover table-border w-100 text-center" id="pending_bom_check">
                <thead>
                    <tr>
    ...
    <div class="d-flex justify-content-between align-items-center">
        <h3 class="ml-4 pt-4 text-bold text-left text-uppercase">Pending Basic Drawing Upload</h3>
        <a class="mr-4 mt-4 mb-2 btn btn-primary btn-sm py-2 px-3" onclick="location.reload();">
            <i class="fa fa-refresh text-light">&#xf021;</i>
        </a>
    </div>
    ...
    <hr class="mx-4" />
    <div class="d-flex justify-content-between align-items-center">
        <h3 class="ml-4 pt-4 text-bold text-left text-uppercase">Pending As-Built Drawing PDF Approval</h3>
        <a class="mr-4 mt-4 mb-2 btn btn-primary btn-sm py-2 px-3" onclick="location.reload();">
            <i class="fa fa-refresh text-light">&#xf021;</i>
        </a>
    </div>
    ...
    <hr class="mx-4" />
    <div class="d-flex justify-content-between align-items-center">
        <h3 class="ml-4 pt-4 text-bold text-left text-uppercase">Upload Final PDF</h3>
        <a class="mr-4 mt-4 mb-2 btn btn-primary btn-sm py-2 px-3" onclick="location.reload();">
            <i class="fa fa-refresh text-light">&#xf021;</i>
        </a>
    </div>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="{{ asset($val->drawing_upload_by_estimation_manager) }}" target="_blank" style="background-color: #169e88; color: #fff; padding: 5px 10px; border-radius: 5px;" class="btn btn-sm" title="View Drawing Estimation">
                                <i class="fa fa-eye"></i>
                            </a>
                            @else
                            <form action="{{ route('upload.drawing.estimation') }}" method="POST" enctype="multipart/form-data" id="upload-drawing-form-{{ $val->id }}">
                                ...
                                <input type="file" name="drawing_estimation" id="drawing-file-input-{{ $val->id }}" accept=".pdf" style="display: none;" onchange="this.form.submit()">
                                <button type="button" style="background-color: #169e88; color: #fff; padding: 5px 10px; border-radius: 5px;" class="btn btn-sm" onclick="document.getElementById('drawing-file-input-{{ $val->id }}').click()" title="Upload Drawing Estimation">
