        ...
        <div class="main_section py-5 bg-white my-4">
            <div class="container-fluid product_container">
                ...
                <div class="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <button class="btn btn-primary mb-4 float-right add-button" data-bs-toggle="modal"
                        data-bs-target="#addModal">+ Add Product Type</button>
                </div>
                        ...
                        <tbody>
                            ...
                            @foreach($producttypes as $producttype)
                                ...
                                <tr>
                                    ...
                                    <td>{{ $producttype->estimated_product_type_weeks }}</td>
                                    <td>
                                    ...
                                    <td>
                                        <button class="btn btn-primary edit-btn" data-id="{{ $producttype->id }}"
                                            ...
                                            data-estimated_weeks="{{ $producttype->estimated_product_type_weeks }}"
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="addProductForm" method="POST" action="{{ route('product-types.store') }}">
                            @csrf
                            <div class="mb-3">
                                <label for="add_product_type_name" class="form-label">Product Type Name<span
                                        class="text-danger">*</span></label>
                                <input type="text" class="form-control" id="add_product_type_name" name="project_type_name"
                                    required>
                            </div>
                            <div class="mb-3">
                                <label for="add_product_family_number" class="form-label">Product Family Number<span
                                        class="text-danger">*</span></label>
                                <input type="text" class="form-control" id="add_product_family_number"
                                    name="product_family_number" required>
                            </div>
                            <div class="mb-3">
                                <label for="add_capacity" class="form-label">Capacity<span
                                        class="text-danger">*</span></label>
                                <input type="number" class="form-control" id="add_capacity" name="capacity" required>
                            </div>
                            <div class="mb-3">
                                <label for="add_estimated_weeks" class="form-label">Estimated Weeks<span
                                        class="text-danger">*</span></label>
                                <input type="number" class="form-control" id="add_estimated_weeks" name="estimated_weeks"
                                    min="0" required>
                            </div>
                            <div class="mb-3">
                                <label for="add_is_active" class="form-label">Status<span
                                        class="text-danger">*</span></label>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="editProductForm" method="POST" action="{{ route('product-types.update') }}">
                            ...
                            <div class="mb-3">
                                <label for="project_type_name" class="form-label">Product Type Name<span
                                        class="text-danger">*</span></label>
                                <input type="text" class="form-control" id="project_type_name" name="project_type_name"
                                    required readonly>
                            </div>
                            <div class="mb-3">
                                <label for="product_family_number" class="form-label">Product Family Number<span
                                        class="text-danger">*</span></label>
                            ...
                            <div class="mb-3">
                                <label for="estimated_weeks" class="form-label">Estimated Weeks<span
                                        class="text-danger">*</span></label>
                                <input type="number" class="form-control" id="estimated_weeks" name="estimated_weeks"
                                    min="0" required>
                            </div>
                            <div class="mb-3">
                                <label for="edit_is_active" class="form-label">Status<span
                                        class="text-danger">*</span></label>
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="button" class="btn btn-secondary canclebutton"
                                    data-bs-dismiss="modal">Cancel</button>
                            </div>
                        </form>
                    </div>
...
@section('scripts')
    ...
    <script>
        ...
        $(document).on('click', '.edit-btn', function () {
            document.getElementById('product_type_id').value = $(this).data('id');
            document.getElementById('project_type_name').value = $(this).data('name');
            document.getElementById('product_family_number').value = $(this).data('family_number');
            document.getElementById('capacity').value = $(this).data('capacity');
            document.getElementById('estimated_weeks').value = $(this).data('estimated_weeks');
            document.getElementById('edit_is_active').value = $(this).data('is_active');
